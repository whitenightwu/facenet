...
def inference(images, keep_probability, phase_train=True, bottleneck_layer_size=128, weight_decay=0.0, reuse=None):
  ...
  with slim.arg_scope([slim.conv2d, slim.separable_conv2d],
    ...
    with slim.arg_scope([slim.batch_norm],
      ...
      print("inflerence mobilenet_v1_arg_scope")
      logits, end_points = mobilenet_v1(images, num_classes=bottleneck_layer_size, dropout_keep_prob=keep_probability ,is_training=phase_train)
    ...
    with slim.arg_scope([slim.batch_norm, slim.dropout],
      ...
      with tf.variable_scope('Logits'):
        if global_pool:
          ...
          print("white -- kernel_size of slim.avg_pool2d : ", kernel_size)
